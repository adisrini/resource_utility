...
public class ResourceUtility extends VBox {
    ...
    private Map<String, ResourceNodeType> formatMap;
    ...
    public ResourceUtility () {
        ...
        formatMap = new HashMap<String, ResourceNodeType>();
        formatMap.put("jpg", ResourceNodeType.IMAGE);
    ...
    private void addFolder () {
        ...
        ComboBox<ResourceNode> directories = new ComboBox<ResourceNode>();
        ...
        ResourceNode node = new ResourceNode("", ResourceNodeType.FOLDER);

        directories.setOnAction(e -> {
            ResourceNode folder = (ResourceNode) directories.getValue();
    ...
    private void addItem () {
        ...
        ResourceNode node = new ResourceNode(importedFile.toString(), formatMap.get(extension));
    ...
    private void showFolders () {
        ...
        for (ResourceNode folder : rt.getFolders()) {
            String prefix = "";
